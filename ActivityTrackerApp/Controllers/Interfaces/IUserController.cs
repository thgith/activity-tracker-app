...
namespace ActivityTrackerApp.Controllers
{
    ...
    public interface IUserController
    {
        ...
        [HttpGet]
        Task<ActionResult<IEnumerable<UserGetDto>>> GetAllUsersAsync();
        ...
        [HttpGet]
        Task<ActionResult<UserGetDto>> GetUserAsync(Guid userId);
        ...
        [HttpPut("{userId}")]
        Task<IActionResult> UpdateUserAsync(Guid userId, UserUpdateDto userPutDto);
